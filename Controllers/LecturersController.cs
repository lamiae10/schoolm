...
namespace SchoolManagementApp.MVC.Controllers
{
    ...
    public class LecturersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,Specialité")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,Specialité")] Lecturer lecturer)
        {
            if (id != lecturer.Id)
            {
                return NotFound();
